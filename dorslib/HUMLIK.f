...
*
* This code is by R. J. Wells
* It is described and published in
* J.Q.S.R.T Vol 62, Issue 1, 1999, pp29-48.
*
...
* Arguments
      ...
      DOUBLE PRECISION X(0:N-1) ! IN Input x array
      DOUBLE PRECISION Y ! IN Input y value >=0.0
      DOUBLE PRECISION K(0:N-1) ! OUT Real (Voigt) array

* Constants
      DOUBLE PRECISION RRTPI ! 1/SQRT(pi)
      PARAMETER ( RRTPI = 0.564189584 )
      DOUBLE PRECISION Y0, Y0PY0, Y0Q ! for CPF12 algorithm
      PARAMETER ( Y0 = 1.5, Y0PY0 = Y0+Y0, Y0Q = Y0*Y0 )
      DOUBLE PRECISION  C(0:5), S(0:5), T(0:5)
      SAVE C, S, T
...
* Local variables
      ...
      DOUBLE PRECISION ABX, XQ, YQ, YRRTPI ! |x|, x^2, y^2, y/SQRT(pi)
      DOUBLE PRECISION XLIM0, XLIM1, XLIM2, XLIM3, XLIM4 ! |x| on region boundaries
      DOUBLE PRECISION  A0, D0, D2, E0, E2, E4, H0, H2, H4, H6 ! W4 temporary variables
      DOUBLE PRECISION  P0, P2, P4, P6, P8, Z0, Z2, Z4, Z6, Z8
      DOUBLE PRECISION  XP(0:5), XM(0:5), YP(0:5), YM(0:5) ! CPF12 temporary values
      DOUBLE PRECISION  MQ(0:5), PQ(0:5), MF(0:5), PF(0:5)
      DOUBLE PRECISION  D, YF, YPY0, YPY0Q
