...
There is more data to download
 via ftp from the {\it UV} and {\it IR\_XSect} directories, put these in your {\it The-DORS/HITRAN/UV\_X} and {\it The-DORS/HITRAN/IR\_X} directories. The {\it HITRAN} site does not
...
Uncompress this, rename the inflated file SMPO.cs, and move it to the
 {\it The-DORS/HITRAN/UV\_X} directory. That's it for the data.
