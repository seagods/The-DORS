...
C     created:   $Date: 2011/03/08 21:09:02 $
C
C  --------------------------------------------------------------------------
...
C
C     Hack
      COMMON /ABSRBsix/ ABSRB1(n_absrb),ABSRB2(n_absrb)
...
C                                                                         F00900
 ...
 30         CONTINUE    
                                                                          F00920
            CALL XINT (V1C,V2C,DVC,C,1.0,V1ABS,DVABS,ABSRB2,1,NPTABS)     F00930
...
C
            CALL XINT (V1C,V2C,DVC,C,1.0,V1ABS,DVABS,ABSRB3,1,NPTABS)     F01450
C
...
C
            CALL XINT (V1C,V2C,DVC,C,1.0,V1ABS,DVABS,ABSRB3,1,NPTABS)     F01550
C
...
c
 80         CONTINUE     
            ...
            CALL XINT (V1C,V2C,DVC,C,1.0,V1ABS,DVABS,ABSRB4,1,NPTABS)
         endif
...
C                                                                         F01880
 ...
 90         CONTINUE    
                                                                          F01900
            CALL XINT (V1C,V2C,DVC,C,1.0,V1ABS,DVABS,ABSRB4,1,NPTABS)     F01910
...
C                                                                         F01130
 ...
 40         CONTINUE  
C                                                                         F01150
            CALL XINT (V1C,V2C,DVC,C,1.0,V1ABS,DVABS,ABSRB5,1,NPTABS)     F01160
...
C
            ...
            CALL XINT (V1C,V2C,DVC,C,1.0,V1ABS,DVABS,ABSRB5,1,NPTABS)
